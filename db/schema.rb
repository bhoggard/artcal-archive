...
ActiveRecord::Schema.define(:version => 20110129070117) do
  ...
  add_index "exhibits", ["location_id"], :name => "index_exhibits_on_location_id"
  add_index "exhibits", ["published"], :name => "index_exhibits_on_published"
  ...
  add_index "locations", ["closed"], :name => "index_locations_on_closed"
  add_index "locations", ["name"], :name => "index_locations_on_name"
  add_index "locations", ["neighborhood_id"], :name => "index_locations_on_neighborhood_id"
  add_index "locations", ["published"], :name => "index_locations_on_published"
